...
<section class="loj-planner" data-robots-satellites-planner data-lang="en" aria-labelledby="rs-planner-heading">
  ...
  <section class="loj-planner__inventory" aria-labelledby="rs-inventory-heading">
    ...
    <label for="rs-stock-prisoner-armor-data">Prisoner Armor Data
    ...
    <label for="rs-stock-power-module">Power Module
    ...
    <label for="rs-stock-advanced-power-module">Advanced Power Module
    ...
    <label for="rs-stock-data-disk">Data Disk
    ...
    <label for="rs-stock-planet-coin">Planet Coin
