...
- **{% include loj-satellite-name.html id="sat_sr_sentinelle" %}:** Reinforcement satellite focused on instant troop training.
- **{% include loj-satellite-name.html id="sat_sr_arbitre" %}:** Combat satellite focused on extra damage during the Cage event.

Detailed upgrade values and final stat breakpoints still need confirmation in-game.

## Overview

### {% include loj-satellite-name.html id="sat_r_laser" %} {% include term.html key="satellite" %}: Top Priority 🔵 {#sat-laser}
...
### {% include loj-satellite-name.html id="sat_sr_sentinelle" %} {% include term.html key="satellite" %}: Season 2 🟣 {#sat-sentinel}
...
### {% include loj-satellite-name.html id="sat_sr_arbitre" %} {% include term.html key="satellite" %}: Season 2 🟣 {#sat-arbitrator}
...
### {% include loj-satellite-name.html id="sat_r_radiance" %} {% include term.html key="satellite" %}: PvE Optimization 🔵 {#sat-radiance}
...
### {% include loj-satellite-name.html id="sat_r_observateur" %} {% include term.html key="satellite" %}: Secondary Support 🔵 {#sat-watcher}
...
7. **{% include loj-satellite-name.html id="sat_r_observateur" %} 🔵 (Support):** Daily resource chest and support bonus
